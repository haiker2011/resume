...
\href{http://www.servicemesher.com/blog/guidance-for-building-a-control-plane-for-envoy-part-3-domain-specific-configuration/}{领域特定配置} \\
\href{http://www.servicemesher.com/blog/guidance-for-building-a-control-plane-for-envoy-part-4-build-for-extensibility/}{构建的可扩展性} \\
...
\location{2019.3}
\begin{tightemize}
    \item 最新情感分析论文整理，在 GitHub 上获得 \textbf{23 stars}
...
\location{2019.3}
\begin{tightemize}
    \item 第三章 Build 翻译，在 GitHub 上获得 \textbf{56 stars}
    \item 其他章节 reviewer
    \end{tightemize}
\sectionsep
...
\href{https://github.com/servicemesher/trans/commits?author=haiker2011}{\bf servicemesher/trans} & 参与项目维护，参与翻译 \\
